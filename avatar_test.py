...
yuri = dokibox.Avatar(name="Yuri", emotes={
    "normal":[yuri_images[yuri_image_root + "1l.png"],yuri_images[yuri_image_root + "1r.png"],yuri_images[yuri_image_root + "a.png"],]
})
...
dokibox.dialogbox("优里!?你也在这里！",name=sayori,sprites=[sayori("left", "shocked"),yuri("right", "normal")])