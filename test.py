...
if __name__ == "__main__":
    ...
    dokibox.dialogbox("1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111", name="莫妮卡", typewriter=True,chardelay=10)